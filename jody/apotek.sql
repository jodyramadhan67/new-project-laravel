...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2447619104ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>localhost:8080 / localhost | phpMyAdmin 5.1.3</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en&v=5.1.3&lang=en"></script>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apotek&table=obat&lang=en">`apotek`.`obat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apotek&table=resep&lang=en">`apotek`.`resep`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan&table=buku&lang=en">`perpustakaan`.`buku`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan&table=penulis&lang=en">`perpustakaan`.`penulis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apotek&table=obat+flu&lang=en">`apotek`.`obat flu`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apotek&table=anti+biotik&lang=en">`apotek`.`anti biotik`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="552d2171333d315b763175484522413a">
...
<nav id="server-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/&lang=en" data-raw-text="localhost">
        Server:        localhost
      </a>
    </li>
