            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="#" @click="addData()" data-target="#modal-default" data-toggle="modal" class="bg-gradient-primary btn-sm">Add New Tablet</a>
                        </a>
                    </div>
                    <!-- /.card-header -->
            ...
            <div class="modal-dialog modal-default">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Tablet</h4>
...
<script type="text/javascript">
    var actionUrl = '{{ url('tablets') }}';
    var apiUrl = '{{ url('api/tablets') }}';
    ...
    var columns = [
        ...
        {render: function (index, row, data,meta) {
          return `
              <a href="#" class="btn bg-gradient-warning btn-sm" onclick="controller.editData(event, ${meta.row})">
                Edit
              </a>
              <a class="btn bg-gradient-danger btn-sm" onclick="controller.deleteData(event, ${data.id})">
              Delete
              </a>`;
...
<!-- <script type="text/javascript">
        var controller = new Vue({
            ...
            methods: {
                addData() {
                    this.data = {};
                    this.actionUrl = '{{ url('tablets') }}';
                    this.editStatus = false;
                    $('#modal-default').modal()
                },
                editData(data) {
                    this.data = data;
                    this.actionUrl = '{{ url('tablets') }}'+'/'+data.id;
                    this.editStatus = true;
                    $('#modal-default').modal()
                },
                deleteData(id) {
                    this.actionUrl = '{{ url('tablets') }}'+'/'+id;
